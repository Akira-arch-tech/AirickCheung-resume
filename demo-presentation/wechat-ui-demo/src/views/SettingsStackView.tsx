...
export function SettingsStackView({ onBack, showToast }: SettingsStackViewProps) {
        ...
        <div className="wx-list" style={{ background: "var(--wx-bg)" }}>
          <div className="wx-section" style={{ marginTop: 0 }}>
            <label className="wx-setting-row">
              <span>深色模式（演示）</span>
              <input type="checkbox" className="wx-switch" readOnly />
            </label>
            <label className="wx-setting-row">
              <span>开启横屏模式（演示）</span>
              <input type="checkbox" className="wx-switch" defaultChecked readOnly />
            </label>
          ...
          <p className="wx-footer-note">PRD 4.13 · 开关仅为 UI，不改变全局主题。</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="wx-subpage">
        ...
        <div className="wx-list" style={{ background: "var(--wx-bg)", textAlign: "center", padding: "32px 16px" }}>
          ...
          <p style={{ fontSize: 14, color: "var(--wx-sub)", margin: 0 }}>版本 0.2（演示构建）</p>
